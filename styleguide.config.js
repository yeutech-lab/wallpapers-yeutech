const { default: createConfig, webpackMerge, config } = require('@yeutech-lab/rollup-umd-documentation/lib/styleguide.config');
...
module.exports = {
  ...
  webpackConfig: webpackMerge(config.webpackConfig, {
    module: {
      rules: [
        {
          test: /\.svg$/,
